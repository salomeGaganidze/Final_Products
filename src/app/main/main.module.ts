...
import { CUstomPipePipe } from '../shoppindcard/prodCustPipe/custom-pipe.pipe';
import { MyDirectiveDirective } from '../shoppindcard/prodCustDirective/my-directive.directive';
